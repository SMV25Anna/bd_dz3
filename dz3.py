...
class MainWindow(QWidget):
    ...
    def setUpMainWindow(self):
        ...
        image = r"C:\gitrep\bd\images\world.png"
        try:
            with open(image):
...
class MainWindo(QWidget):
    ...
    def setUpMainWindo(self):
        ...
        user_label.setText("Анна Чаречанская")
        ...
        languages_label.setText("Python | C# | MySQL ")
        ...
        developer_label.setText("Оператор 1С")
        developer_label.move(15, 480)
        dev_dates_label = QLabel(self)
        dev_dates_label.setText("Апрель 2024 - настоящее время")
        dev_dates_label.setFont(QFont("Arial", 10))
        dev_dates_label.move(15, 500)
        driver_label = QLabel(self)
        driver_label.setText("Репетитор по физике")
        driver_label.move(15, 530)
        driver_dates_label = QLabel(self)
        driver_dates_label.setText("Сентябрь 2025 - настоящее время")
        driver_dates_label.setFont(QFont("Arial", 10))
        driver_dates_label.move(15, 550)
        driver_label = QLabel(self)
        driver_label.setText("Помощник экономиста")
        driver_label.move(15, 580)
        driver_dates_label = QLabel(self)
        driver_dates_label.setText("Июль 2021 - Август 2023")
        driver_dates_label.setFont(QFont("Arial", 10))
        driver_dates_label.move(15, 600)
